...
const moviesFromServer = [
  ...
  },
  {
    ...
    description: `Jack Hall, paleoclimatologist, must make a daring trek from
    Washington, D.C. to New York City to reach his son, trapped in the cross-hairs of a sudden international storm which plunges the planet into a new Ice Age.`,
    imgUrl:
      'https://m.media-amazon.com/images/M/' +
      'MV5BMTY4YWMzMTMtZjUyOS00OGY1LTljMGUtOWU5ZjYzM' +
      'jc2ZTMwXkEyXkFqcGdeQXVyMTYzMDM0NTU@.' +
  ...
  },
  {
    ...
    imgUrl:
      'https://m.media-amazon.com/images/M/' +
      'MV5BMjEwMzMxODIzOV5BMl5BanBnXkFtZTgwNz' +
      'g3OTAzMDI@._V1_SY1000_SX675_AL_.jpg',
    imdbUrl: 'https://www.imdb.com/title/tt3748528',
    imdbId: 'tt3748528',
  },
  {
    title: 'The Holiday',
    description: `Two women troubled with guy-problems swap homes in each
    others countries, where they each meet a local guy and fall in love.`,
    imgUrl:
      'https://m.media-amazon.com/images/M/' +
      'MV5BMTI1MDk4MzA2OF5BMl5BanBnXkFtZTYwMjQ3NDc3._V1_.jpg',
